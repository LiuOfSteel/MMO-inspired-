            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(mBlueList2.size()!=0){
                        ...
                        if(scanTimes>300){
                            if(scanState == 1){
                                Toast.makeText(Get2Activity.this, "You may not be in the scanning area", Toast.LENGTH_SHORT).show();
                                textView11.setText("You may not in scanning area");
                        ...
                        for(int i = 0; i < mBlueList2.size(); i++){
                            ...
                            if ((mBlueList2.get(i).getAddress().equals(bluetoothAddress1)) && (!mBlueList2.get(i).getAddress().equals(LoginActivity.currentBluetoothAddress))) {
                                ...
                                Toast.makeText(Get2Activity.this, "Check successful1", Toast.LENGTH_SHORT).show();
                                pushToDatabase();
                                i = mBlueList2.size();
                                break;
                                //   return;
                                ...
                                LoginActivity.currentBluetoothAddress = mBlueList2.get(i).getAddress();
                                Toast.makeText(Get2Activity.this, "Check successful2", Toast.LENGTH_SHORT).show();
                                pushToDatabase();
                                i = mBlueList2.size();
                                break;
                                //   return;
                                ...
                                LoginActivity.currentBluetoothAddress = mBlueList2.get(i).getAddress();
                                Toast.makeText(Get2Activity.this, "Check successful3", Toast.LENGTH_SHORT).show();
                                pushToDatabase();
                                i = mBlueList2.size();
                                break;
                                //   return;
                                ...
                                LoginActivity.currentBluetoothAddress = mBlueList2.get(i).getAddress();
                                Toast.makeText(Get2Activity.this, "Check successful4", Toast.LENGTH_SHORT).show();
                                pushToDatabase();
                                i = mBlueList2.size();
                                break;
                                //   return;
                            } else if (mBlueList2.get(i).getAddress().equals(LoginActivity.currentBluetoothAddress)) {
                                Toast.makeText(Get2Activity.this, "Your need go to a new area", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Get2Activity.this, "there is no bluetooth signal around", Toast.LENGTH_SHORT).show();
                    }
                }
...
//        lisetView = (ListView) findViewById(R.id.list_view);
        ...
        textView11.setText("welcome, there!");
    ...
    public void pushToDatabase(){
        ...
        mBluetoothAdapter.stopLeScan(mLeScanCallback);
        scanState = 0;
        textView11.setText("check successful!");
    }
